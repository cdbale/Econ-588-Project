...
full_data <- full_data %>%
  ...
  mutate(f_upc = as_factor(upc), 
         ...
         f_brand_code_uc = as_factor(brand_code_uc),
         f_retailer_code = as_factor(retailer_code))
```
...
store_upc_cluster_se <- enframe(store_upc_cluster_se, name = "Variable", value = "Clustered: UPC + Store")
